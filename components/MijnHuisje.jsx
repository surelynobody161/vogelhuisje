    ...
    return (
        <Pressable style={styles.huisjeContainer} onPress={() => {console.log('huisje 1')}}>
            ...
            <View style={styles.detailsButtonView}>
                <Pressable style={styles.detailsButton} onPress={() => {console.log('details')}}>
                    <Text style={styles.detailsText}>Details <MaterialIcons style={styles.detailsText} name="arrow-forward-ios" size={16} color="black" /> </Text>
                </Pressable>
            </View>
        </Pressable>
    )
