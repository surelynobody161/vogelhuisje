...
export default function Slide2() {
    ...
    const fullTitle = 'Help de vogelpopulatie.';
    const fullSubtitle = 'Huur bij ons een huisje en help de vogelpopulatie';
        ...
        <View style={styles.container}>
            <View style={styles.imageWrapper}>
                <Animated.View style={{ transform: [{ translateY: imageAnim }] }}>
                    <Image
                        source={require('../assets/images/zwaluw.png')}
                        style={styles.image}
                    />
                    <LinearGradient
            ...
            <View style={styles.bottom}>
                ...
                <ProgressBar total={5} currentIndex={2} />
